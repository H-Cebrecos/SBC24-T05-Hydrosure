/*
 * AS726X.h
 * Adaptado de Arduino a ESP-IDF en C
 */
...
#define AS726X_ADDR 0x49 // Dirección I2C de 7 bits sin desplazar
...
#define POLLING_DELAY 5 // Milisegundos de espera entre chequeos de cambios en registros virtuales
#define MAX_RETRIES 3
#define TIMEOUT 3000

// Estructura para manejar el dispositivo
typedef struct {
    i2c_port_t i2c_port;
    uint8_t i2c_addr;
    uint8_t gain;
...
// Funciones para obtener las lecturas de colores
...
// Funciones para obtener las lecturas NIR
...
// Funciones para obtener X, Y, Z, NIR, Dark, Clear
...
// Funciones para obtener datos calibrados
